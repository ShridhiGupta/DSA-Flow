...
export default function Searching() {
  ...
  const searchingAlgorithms = [
    ...
    },
    {
      ...
      type: 'divide-conquer',
      difficulty: 'Advanced',
      description: 'Search by estimating position based on value distribution',
      timeComplexity: 'O(log log n)',
      spaceComplexity: 'O(1)',
      icon: 'ri-line-chart-line',
      color: 'purple',
      applications: ['Uniformly distributed data', 'Large sorted arrays', 'Numeric data'],
      prerequisites: 'Sorted, uniformly distributed data',
      bestCase: 'O(1)',
      worstCase: 'O(n)',
      dataStructure: 'Sorted Array'
    },
    {
      ...
      type: 'divide-conquer',
      difficulty: 'Advanced',
      description: 'Find range then apply binary search',
      timeComplexity: 'O(log n)',
      spaceComplexity: 'O(1)',
      icon: 'ri-rocket-line',
      color: 'orange',
      applications: ['Unbounded arrays', 'Unknown array size', 'Infinite sequences'],
      prerequisites: 'Sorted data',
      bestCase: 'O(1)',
      worstCase: 'O(log n)',
      dataStructure: 'Sorted Array'
    },
    {
      ...
      type: 'divide-conquer',
      difficulty: 'Intermediate',
      description: 'Divide array into three parts and search',
      timeComplexity: 'O(log n)',
      spaceComplexity: 'O(1)',
      icon: 'ri-split-cells-vertical',
      color: 'teal',
      applications: ['Finding maximum/minimum', 'Unimodal functions', 'Optimization'],
      prerequisites: 'Sorted or unimodal data',
      bestCase: 'O(1)',
      worstCase: 'O(log n)',
      dataStructure: 'Sorted Array'
    },
    {
      ...
      color: 'indigo',
      applications: ['Sorted arrays', 'Block-based searching', 'Cache-friendly searches'],
      prerequisites: 'Sorted data',
      bestCase: 'O(1)',
      worstCase: 'O(√n)',
      dataStructure: 'Sorted Array'
