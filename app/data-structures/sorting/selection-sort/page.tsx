...
export default function SelectionSort() {
  const [array, setArray] = useState([64, 25, 12, 22, 11, 13, 5, 6, 7, 9]);
  ...
  const selectionSort = async () => {
    ...
    setCurrentStep('Starting Selection Sort algorithm');
    await sleep(1000);
    ...
    for (let i = 0; i < n - 1; i++) {
      ...
      setCurrentStep(`Finding minimum element in unsorted portion from index ${i} to ${n - 1}`);
      await sleep(800);
      ...
      setCurrentStep(`Element ${arr[i]} is now in its correct position at index ${i}`);
  ...
  const resetArray = () => {
    setArray([64, 25, 12, 22, 11, 13, 5, 6, 7, 9]);
    setCurrentStep('');
    setHighlightedIndices([]);
    setSortedIndices([]);
    setMinIndex(-1);
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center mb-4">
            <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mr-4">
              <i className="ri-cursor-line text-2xl text-purple-600"></i>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start">
                  ...
                  <span>Find the minimum element in the unsorted portion</span>
                </li>
                <li className="flex items-start">
                  <i className="ri-checkbox-circle-fill text-purple-600 mr-2 mt-1"></i>
                  <span>Swap it with the first element of unsorted portion</span>
                </li>
                <li className="flex items-start">
                  <i className="ri-checkbox-circle-fill text-purple-600 mr-2 mt-1"></i>
                  <span>Move the boundary of sorted portion one element right</span>
                </li>
                <li className="flex items-start">
                  <i className="ri-checkbox-circle-fill text-purple-600 mr-2 mt-1"></i>
...
// Usage
const array = [64, 25, 12, 22, 11, 13, 5, 6, 7, 9];
console.log(selectionSort(array)); // [5, 6, 7, 9, 11, 12, 13, 22, 25, 64]`}
            </pre>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm mb-8">
          ...
          <div className="space-y-4">
            <div className="border border-gray-200 rounded-lg p-4 hover:border-purple-300 transition-colors">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Implement Selection Sort</h3>
                  <p className="text-gray-600">Write your own implementation of selection sort from scratch</p>
            ...
            <div className="border border-gray-200 rounded-lg p-4 hover:border-purple-300 transition-colors">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Stable Selection Sort</h3>
                  <p className="text-gray-600">Modify selection sort to make it stable</p>
                  <div className="flex items-center gap-4 mt-2">
            ...
            <div className="border border-gray-200 rounded-lg p-4 hover:border-purple-300 transition-colors">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Selection Sort Variations</h3>
                  <p className="text-gray-600">Implement selection sort variations (max selection, double selection)</p>
                  <div className="flex items-center gap-4 mt-2">
        ...
        <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Link href="/data-structures/sorting/bubble-sort" className="block">
              <div className="bg-white rounded-lg p-6 hover:shadow-lg transition-shadow">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Bubble Sort</h3>
                <p className="text-gray-600 text-sm">Simple comparison-based sorting algorithm</p>
                <div className="mt-4 text-purple-600 font-medium text-sm">Learn More →</div>
              </div>
            </Link>
